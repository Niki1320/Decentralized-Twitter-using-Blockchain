...
The platform is a decentralized social media something similar to twitter but totally in a decentralized way having no server. The platform has a smart contract containing all the important logic and is deployed on Ethereum Blockchain using Gananche. Some of the features of the platform are:
