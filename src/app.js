App = {
  ...
  load: async () => {
    ...
    loadContract: async () => {
        ...
        App.Polygon="0x69b1aDc64f300f87cc006968e91405C94f2aFaa3"
        ...
        // else if (App.network == "private") App.contracts.dwitter = new web3.eth.Contract(abi, App.Polygon);
        ...
        //   if (networkId == 42) {
        //       // Kovan
        //       App.contracts.dwitter = new web3.eth.Contract(abi, App.Kovan);
        //   } else if (networkId == 4) {
        //       // Rinkeby
        //       App.contracts.dwitter = new web3.eth.Contract(abi, App.Rinkeby);
        //   } else if (networkId == 3) {
        //       // Ropsten
        //       App.contracts.dwitter = new web3.eth.Contract(abi, App.Ropsten);
        //   } else if (networkId == 5) {
        //       // Goerli
        //       App.contracts.dwitter = new web3.eth.Contract(abi, App.Goerli);
        //   } else if (networkId == 80001) {
        //       // Mumbai testnet
        //       App.contracts.dwitter = new web3.eth.Contract(abi, App.Polygon);
        //   } else {
        //       App.showError("Please connect to a supported network");
        //       return;
        //   }
        
  
      //     // Call the function that depends on the contract
      //     await App.loadUserProfile();
      // } catch (error) {
      //     console.error("Error getting network ID:", error);
      //     App.showError("Error getting network ID");
      // }
      ...
      render: async () => {
        ...
        if (!App.contracts || !App.contracts.dwitter) {
